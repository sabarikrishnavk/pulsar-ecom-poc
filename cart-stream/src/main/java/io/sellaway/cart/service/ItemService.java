...
public class ItemService {
    ...
    @PulsarConsumer(topic=CartConstants.TOPIC_CART_ITEM_ADD, clazz= CartLineItem.class, serialization = Serialization.JSON, type = SubscriptionType.Exclusive)
    ...
    @PulsarConsumer(topic=CartConstants.TOPIC_CART_ITEM_UPDATE, clazz= CartLineItem.class, serialization = Serialization.JSON, type = SubscriptionType.Exclusive)
    ...
    @PulsarConsumer(topic=CartConstants.TOPIC_CART_ITEM_DELETE, clazz= CartLineItem.class, serialization = Serialization.JSON, type = SubscriptionType.Exclusive)
